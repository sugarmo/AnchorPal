...
public protocol LayoutDimensionRelatable: ConstraintSubjectable {
    static func constraints<D>(_ receiver: Self, relation: ConstraintRelation, to other: D, multiplier: some ConstraintMultiplierValuable, constant: some ConstraintConstantValuable) -> [NSLayoutConstraint] where D: LayoutDimensionable
}

extension LayoutDimensionable {
    public static func constraints<D>(_ receiver: Self, relation: ConstraintRelation, to other: D, multiplier: some ConstraintMultiplierValuable, constant: some ConstraintConstantValuable) -> [NSLayoutConstraint] where D: LayoutDimensionable {
...
extension Array: LayoutDimensionRelatable where Element: LayoutDimensionRelatable {
    public static func constraints<D>(_ receiver: [Element], relation: ConstraintRelation, to other: D, multiplier: some ConstraintMultiplierValuable, constant: some ConstraintConstantValuable) -> [NSLayoutConstraint] where D: LayoutDimensionable {
...
extension AnchorPair: LayoutDimensionRelatable where F: LayoutDimensionRelatable, S: LayoutDimensionRelatable {
    public static func constraints<D>(_ receiver: AnchorPair<F, S>, relation: ConstraintRelation, to other: D, multiplier: some ConstraintMultiplierValuable, constant: some ConstraintConstantValuable) -> [NSLayoutConstraint] where D: LayoutDimensionable {
